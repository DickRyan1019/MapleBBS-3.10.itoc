...
static MENU menu_admin[] =
{
  ...
  a_editbrd, PERM_ALLBOARD, M_SYSTEM,
  "QSetBoard  ◤ 設定看板 ◢",

  a_innbbs, PERM_ALLBOARD, M_SYSTEM,
  "InnBBS     ◤ 轉信設定 ◢",

#ifdef HAVE_REGISTER_FORM
  a_register, PERM_ALLREG, M_SYSTEM,
  "Register   ◤ 審註冊單 ◢",

  a_regmerge, PERM_ALLREG, M_SYSTEM,
  "Merge      ◤ 復原審核 ◢",
#endif

  a_xfile, PERM_ALLADMIN, M_XFILES,
  "Xfile      ◤ 系統檔案 ◢",
  
  a_resetsys, PERM_ALLADMIN, M_SYSTEM,
  "BBSreset   ◤ 重置系統 ◢",

  a_restore, PERM_SYSOP, M_SYSTEM,
  "TRestore   ◤ 還原備份 ◢",
...
static MENU menu_mail[] =
{
  ...
  m_bm, PERM_ALLADMIN, M_SMAIL,
  "BM All     ├ 板主通告 ┤",	/* itoc.000512: 新增 m_bm */
  
  m_all, PERM_ALLADMIN, M_SMAIL,
...
static MENU menu_song[] =
{
  ...
  itoc.011011.註解:
  為了避免 acct_save 用太多浪費 I/O，又要避免 user multi-login 玩來洗錢，
...
static MENU menu_game1[] =
{
  ...
  main_recall, 0, M_GAME,
  "4Recall    ♂ 回憶之卵 ♀",

  main_mine, 0, M_GAME,
  "5Mine      ♂ 亂踩地雷 ♀",

  main_fantan, 0, M_GAME, 
  "6Fantan    ♂ 番攤接龍 ♀",

  main_dragon, 0, M_GAME,
  "7Dragon    ♂ 接龍遊戲 ♀",
...
{
  main_pip, PERM_BASIC, M_GAME,
  "0Chicken   ♂ 電子小雞 ♀",

  main_pushbox, 0, M_GAME,
  "1PushBox   ♂ 倉庫番番 ♀",

  main_tetris, 0, M_GAME,
  "2Tetris    ♂ 俄羅斯塊 ♀",

  main_reversi, 0, M_GAME,
  "3Reversi   ♂ 淺灰大戰 ♀",
...
{
  x_bank, PERM_BASIC, M_GAME,
  "Bank       ♂ 信託銀行 ♀",

  b_invis, PERM_BASIC, M_GAME,
  "Invis      ♂ 隱形現身 ♀",

  b_cloak, PERM_BASIC, M_GAME,
  "Cloak      ♂ 無限隱形 ♀",

  b_mbox, PERM_BASIC, M_GAME,
  "Mbox       ♂ 信箱無限 ♀",

  b_xempt, PERM_BASIC, M_GAME,
  "Xempt      ♂ 永久保留 ♀",
...
{
  vote_all, PERM_BASIC, M_VOTE,	/* itoc.010414: 投票中心 */
  "VoteAll    ♂ 投票中心 ♀",
  ...
  x_loveletter, 0, M_READA,
  "LoveLetter ♂ 情書撰寫 ♀",
#endif

  x_password, PERM_VALID, M_XMODE,
  "Password   ♂ 忘記密碼 ♀",

#ifdef HAVE_CLASSTABLE
  main_classtable, PERM_BASIC, M_XMODE,
  "ClassTable ♂ 功\課時段 ♀",
#endif

#ifdef HAVE_CREDIT
  main_credit, PERM_BASIC, M_XMODE,
  "MoneyNote  ♂ 記帳手札 ♀",
#endif

#ifdef HAVE_CALENDAR
  main_todo, PERM_BASIC, M_XMODE,
  "XTodo      ♂ 個人行程 ♀",

  main_calendar, 0, M_XMODE,
  "YCalendar  ♂ 萬年月曆 ♀",
#endif
